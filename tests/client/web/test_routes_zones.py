...
class TestGetZones:
    ...
    def test_returns_zone_fields(self, tmp_path) -> None:
        zone = Zone(
            **{
                k: v if k != 'polygon' else [tuple(p) for p in v]
                for k, v in _zone_payload().items()
            }
        )
...
class TestCreateZone:
    def test_valid_create_returns_201(self, tmp_path) -> None:
        ...
        response = client.post(
            '/api/zones', json={**_zone_payload(), 'version': version}
        )
...
class TestEditZone:
    def test_valid_edit_returns_200(self, tmp_path) -> None:
        ...
        response = client.put(
            '/api/zones/z1',
            json={'polygon': [[1, 1], [2, 1], [2, 2]], 'version': version},
        )
    ...
    def test_unknown_zone_returns_404(self, tmp_path) -> None:
        ...
        version = client.get('/api/zones').get_json()['version']
        response = client.put(
            '/api/zones/unknown', json={'name': 'X', 'version': version}
        )
    ...
    def test_invalid_polygon_returns_400(self, tmp_path) -> None:
        ...
        version = client.get('/api/zones').get_json()['version']
        response = client.put(
            '/api/zones/z1', json={'polygon': [[1, 1]], 'version': version}
        )
        assert response.status_code == 400
    ...
    def test_toggle_enabled_preserves_polygon(self, tmp_path) -> None:
        ...
        version = client.get('/api/zones').get_json()['version']
        response = client.put(
            '/api/zones/z1', json={'enabled': False, 'version': version}
        )
        assert response.status_code == 200
...
class TestDeleteZone:
    ...
    def test_stale_version_returns_409(self, tmp_path) -> None:
        ...
        client, _ = _client(tmp_path, zones=[zone])
        response = client.delete('/api/zones/z1?version=-1')
        assert response.status_code == 409


class TestCalibrationPage:
    def test_calibration_page_is_served_with_live_frame_backdrop(
        self, tmp_path
    ) -> None:
        client, _ = _client(tmp_path)
